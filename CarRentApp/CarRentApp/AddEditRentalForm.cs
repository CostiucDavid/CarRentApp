...
namespace CarRentApp
{
    public partial class AddEditRentalForm : Form
    {
        ...
        {
            var cars = _carRentDbContext.TypesOfCars.Select(x => new { x.Id, Name = x.Make + " " + x.Model}).ToList();
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var dateReturned = dtpDataRented.Value;
                ...
                {
                    MessageBox.Show("Back in time is not working!");
                }
                ...
                if (_carRentalRecord != null)
                {
                    ...
                    //Update
                    _carRentDbContext.CarRentalRecords.AddOrUpdate();
        ...
        private void tbTypeOfCar_TextChanged(object sender, EventArgs e)
        {
